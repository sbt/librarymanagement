...
class EvictionWarningSpec extends BaseIvySpecification {
  ...
  def akkaActor214 = ModuleID("com.typesafe.akka", "akka-actor", "2.1.4").copy(configurations = Some("compile")) cross CrossVersionUtil.binary
  def akkaActor230 = ModuleID("com.typesafe.akka", "akka-actor", "2.3.0").copy(configurations = Some("compile")) cross CrossVersionUtil.binary
  def akkaActor234 = ModuleID("com.typesafe.akka", "akka-actor", "2.3.4").copy(configurations = Some("compile")) cross CrossVersionUtil.binary
  def scala2102 = ModuleID("org.scala-lang", "scala-library", "2.10.2").copy(configurations = Some("compile"))
  def scala2103 = ModuleID("org.scala-lang", "scala-library", "2.10.3").copy(configurations = Some("compile"))
  def scala2104 = ModuleID("org.scala-lang", "scala-library", "2.10.4").copy(configurations = Some("compile"))
  def commonsIo13 = ModuleID("commons-io", "commons-io", "1.3").copy(configurations = Some("compile"))
  def commonsIo14 = ModuleID("commons-io", "commons-io", "1.4").copy(configurations = Some("compile"))
  def commonsIo24 = ModuleID("commons-io", "commons-io", "2.4").copy(configurations = Some("compile"))
  def bnfparser10 = ModuleID("ca.gobits.bnf", "bnfparser", "1.0").copy(configurations = Some("compile")) // uses commons-io 2.4
  def unfilteredUploads080 = ModuleID("net.databinder", "unfiltered-uploads", "0.8.0").copy(configurations = Some("compile")) cross CrossVersionUtil.binary // uses commons-io 1.4
  def bananaSesame04 = ModuleID("org.w3", "banana-sesame", "0.4").copy(configurations = Some("compile")) cross CrossVersionUtil.binary // uses akka-actor 2.1.4
  def akkaRemote234 = ModuleID("com.typesafe.akka", "akka-remote", "2.3.4").copy(configurations = Some("compile")) cross CrossVersionUtil.binary // uses akka-actor 2.3.4
