...
/**
 * Copied from https://github.com/coursier/coursier/blob/0b5b2f25f2017d4c000eb702e574998c690cf3f7/sbt-coursier/src/main/scala/coursier/ToSbt.scala
 */
private[this] object ToSbt {
  ...
  val moduleReport =
    caching[(Dependency, Seq[(Dependency, Project)], Project, Seq[(Artifact, Option[File])]),
            sbt.librarymanagement.ModuleReport] {
  ...
  def updateReport(
      ...
      keepPomArtifact: Boolean = false,
      includeSignatures: Boolean = false
  ): sbt.librarymanagement.UpdateReport = {
