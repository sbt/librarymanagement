...
import coursier.{
  ...
  Project,
  Repository,
  MavenRepository => CMavenRepository
}
import coursier.core.{ Authentication, Info }
...
// copied from https://github.com/coursier/coursier/blob/master/sbt-coursier/src/main/scala/coursier/FromSbt.scala
